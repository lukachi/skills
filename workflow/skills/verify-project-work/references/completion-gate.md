...
The CLI validates the record's structure. It cannot prove that a conversation
occurred or that semantic evidence is correct. The agent must record a
maintainer approval only after an explicit decision, and the maintainer remains
